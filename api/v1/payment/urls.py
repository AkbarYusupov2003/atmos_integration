...
urlpatterns = [
    ...
    # Pay Scheduler
    path("atmos/pay-scheduler/create", views.AtmosPaySchedulerCreateAPIView.as_view()), # TODO
    path("atmos/pay-scheduler/confirm", views.AtmosPaySchedulerConfirmAPIView.as_view()), # TODO
    path("atmos/pay-scheduler/change", views.AtmosPaySchedulerChangeAPIView.as_view()), # TODO
]
